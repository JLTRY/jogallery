...
use JLTRY\Plugin\EditorsXtd\JOGallery\Extension\JOGallery;
        ...
        if (!PluginHelper::isEnabled('editors-xtd', 'jofbkpost')) {
            ...
            $container->set(
                ...
                function (Container $container) {
                    $config = (array) PluginHelper::getPlugin('editors-xtd', 'jogallery');
                    ...
                    $lang->load('plg_editors-xtd_jogallery', JPATH_PLUGINS . '/editors-xtd/jogallery');
                    return $plugin;
                }
            );
    }
