 ...
 * @link https://github.com/JLTRY/jofbkpost
 */
 ...
 */
// phpcs:ignore
class plg_JoGalleryInstallerScript implements InstallerScriptInterface
{
    /**
    ...
    public function preflight(string $type, InstallerAdapter $adapter): bool
    {
        ...
        $lang->load('plg_editor-xtd_jogallery.sys', dirname(__FILE__), 'en-GB');
        return true;
    }
