...
<form action="index.php?option=com_jogallery&view=jogalleries" method="post" id="adminForm" name="adminForm">
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <th width="90%">
                <?php echo HTMLHelper::_('grid.sort', 'COM_JOGALLERY_JOGALLERYS_NAME', 'directory', $listDirn, $listOrder); ?>
            </th>
            <th width="5%">
            ...
            <?php if (!empty($this->items)) : ?>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo $link; ?>" title="<?php echo Text::_('COM_JOGALLERY_EDIT_JOGALLERY'); ?>">
                                <?php echo $row->directory; ?>
                            </a>
                        </td>
                        <td align="center">
                            <?php echo HTMLHelper::_('jgrid.published', $row->published, $i, 'jogalleries.', true, 'cb'); ?>
                        </td>
                        <td align="center">
                            <?php echo $row->id; ?>
                        </td>
