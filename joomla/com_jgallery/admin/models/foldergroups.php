...
/**
 * JCoachingModelfoldergroups Model
 *
 * @since  0.0.1
 */
class JGalleryModelFoldergroups extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	static public function getInstance($type = 'foldergroups', $prefix= "JGalleryModel", $config=array()) {
