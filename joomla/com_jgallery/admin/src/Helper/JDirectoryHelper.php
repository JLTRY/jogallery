...
define("JPATH_LAYOUTS", JPATH_ADMINISTRATOR . '/components/com_jgallery/layouts');
...
class JDirectory
{
	...
	{
		return Uri::root(true) . "/index.php?option=com_jgallery&view=jgallery&directory64=". base64_encode(utf8_encode("{$parentdir}/{$directory}")) ."&parent=" .$parentlevel . "&Itemid=0" . "&id=" . $id;
	}
